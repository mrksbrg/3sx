...
static s32 eff09_10000_animation_updates_enabled(const WORK_Other* ewk) {
    return !EXE_flag && !Game_pause && ewk->wu.hit_stop;
}
...
void eff09_10000(WORK_Other* ewk) {
    ...
    case 1:
        if (eff09_10000_animation_updates_enabled(ewk)) {
            char_move(&ewk->wu);
...
static s32 eff09_15000_animation_updates_enabled(const WORK_Other* ewk) {
    return !EXE_flag && !Game_pause && ewk->wu.hit_stop;
}
...
void eff09_15000(WORK_Other* ewk) {
    ...
    case 1:
        if (eff09_15000_animation_updates_enabled(ewk)) {
            char_move(&ewk->wu);
...
static s32 eff09_16000_animation_updates_enabled(const WORK_Other* ewk) {
    return !EXE_flag && !Game_pause && ewk->wu.hit_stop;
}
...
void eff09_16000(WORK_Other* ewk) {
    ...
    case 1:
        if (eff09_16000_animation_updates_enabled(ewk)) {
            char_move(&ewk->wu);
